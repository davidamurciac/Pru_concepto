 ...
 *
 * $Header: DHelperExpedienteGeneracion130v9.java, 3, 2/3/09 7:28:20 PM COT, ARMANDO PEREA MORA$
 */
...
public class DHelperExpedienteGeneracion130v9 extends DHelperExpedienteGeneracion130 {
	//~--- Campos Estaticos -

	private static final Logger logger = Logger.getLogger(DHelperExpedienteGeneracion130v9.class);
	 ...
	 */
	public DHelperExpedienteGeneracion130v9(DComandoAplicacion comando) {
		super(comando);
	}
	...
	protected void inicializarVariablesInternas() {
		...
		setIdeTareaDiligenciarDec(new Long(ids.IDE_TAREA_DILIGENCIAR_DECLARACION_CONSOLIDADA_V9));

		setIdeParTareaIdeDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_DOC_DECLARACION_CONSOLIDADA_V9));
		setIdeParTareaNumRepDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_NUM_REP_DOC_DECLARACION_CONSOLIDADA_V9));
		setIdeParTareaIdeDocSolicitud(new Integer(ids.IDE_PAR_TAREA_DOC_SOLICITUD_CONSOLIDADA_V9));
		setIdeParTareaEsRepeticion(new Integer(ids.IDE_PAR_TAREA_ES_REPETICION_CONSOLIDADA_V9));
	}
