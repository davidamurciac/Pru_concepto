...
public class DHelperExpedienteGeneracion130v2 extends DHelperExpedienteGeneracion130 {
	//~--- Campos Estaticos -

	private static final Logger logger = Logger.getLogger(DHelperExpedienteGeneracion130v2.class);
	 ...
	 */
	public DHelperExpedienteGeneracion130v2(DComandoAplicacion comando) {
		super(comando);
	}
	...
	protected void inicializarVariablesInternas() {
		...
		setIdeTareaDiligenciarDec(new Long(ids.IDE_TAREA_DILIGENCIAR_DECLARACION_CONSOLIDADA_V2));

		setIdeParTareaIdeDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_DOC_DECLARACION_CONSOLIDADA_V2));
		setIdeParTareaNumRepDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_NUM_REP_DOC_DECLARACION_CONSOLIDADA_V2));
		setIdeParTareaIdeDocSolicitud(new Integer(ids.IDE_PAR_TAREA_DOC_SOLICITUD_CONSOLIDADA_V2));
		setIdeParTareaEsRepeticion(new Integer(ids.IDE_PAR_TAREA_ES_REPETICION_CONSOLIDADA_V2));
	}
