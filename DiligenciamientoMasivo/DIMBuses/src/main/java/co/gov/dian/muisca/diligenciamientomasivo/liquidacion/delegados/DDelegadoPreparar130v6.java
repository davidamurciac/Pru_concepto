...
import co.gov.dian.muisca.diligenciamiento.liquidacion.IDCasillasFormulario490;
 ...
 * @version 1.0
 */
public class DDelegadoPreparar130v6 extends DDelegadoPreparar{
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Parámetros para la Liquidación del Formulario 130 versión 6.");
        ...
        defLiquidacion.setValorCasilla(IDCasillasFormulario490.ANNO, docLiquidacion);
        // Es un formulario aperiódico.
        defLiquidacion.setValorCasilla(IDCasillasFormulario490.PERIODO, new Integer(1));
