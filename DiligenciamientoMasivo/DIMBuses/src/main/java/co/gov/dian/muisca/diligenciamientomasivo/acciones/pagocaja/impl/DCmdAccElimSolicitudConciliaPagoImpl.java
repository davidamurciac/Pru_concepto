 ...
 * </pre>
 */
public class DCmdAccElimSolicitudConciliaPagoImpl extends DCmdAccElimSolicitudConciliaPago {
  ...
  protected void ejecutarComando() {
    try {
      DCmdSrvElimSolicitudConciliaPago servicio = (DCmdSrvElimSolicitudConciliaPago) getServicio("diligenciamientomasivo.pagocaja.DCmdSrvElimSolicitudConciliaPago");
