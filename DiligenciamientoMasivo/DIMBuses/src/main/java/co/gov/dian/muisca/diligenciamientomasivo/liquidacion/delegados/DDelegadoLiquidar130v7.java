...
public class DDelegadoLiquidar130v7 extends DDelegadoLiquidar{
    ...
    public String getDescripcion() {
        return "Delegado que implementa la Liquidación para el Formulario 130 versión 7.";
    }
...
/*        if(!isFraccion){
        ...
        DCalculosLiqF490v7.asignarValoresDocLiquidado(
