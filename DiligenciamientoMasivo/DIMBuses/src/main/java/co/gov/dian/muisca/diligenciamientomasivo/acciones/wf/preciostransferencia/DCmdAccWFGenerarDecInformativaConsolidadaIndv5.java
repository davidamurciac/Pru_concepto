...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv5 extends DComandoWF {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5525872868719835136L;

	/*Atributos*/
	protected static Logger logger = Logger.getLogger(DCmdAccWFGenerarDecInformativaConsolidadaIndv5.class);
	...
	public DCmdAccWFGenerarDecInformativaConsolidadaIndv5() {
	}
	...
	protected void asignarWF(IDComando comando) {
		if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidadaIndv5){
			DCmdAccWFGenerarDecInformativaConsolidadaIndv5 copia = (DCmdAccWFGenerarDecInformativaConsolidadaIndv5)comando;
	...
	public Object clonar() {
		return new DCmdAccWFGenerarDecInformativaConsolidadaIndv5();
	}
	...
	public String getDescripcion() {
		return "Comando WF que genera una declaración 120 Version 5";
	}
