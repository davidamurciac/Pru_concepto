 ...
 * </pre>
 */
public class DCmdSrvElimDetRegDiaMincultura extends DComandoServicioInterno {
	private static final long serialVersionUID = 884437874L; 
	 ...
	 * la eliminación de DetRegDiaMincultura
	 */
	...
	public Object clonar() {
		return new DCmdSrvElimDetRegDiaMincultura();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvElimDetRegDiaMincultura) {
			DCmdSrvElimDetRegDiaMincultura copia = (DCmdSrvElimDetRegDiaMincultura) comando;
