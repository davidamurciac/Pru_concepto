 ...
 * </pre>
 */
public class DCmdSrvConsDeclaracionContribucionParafiscalPatrocinador extends DComandoServicioInterno {
	private static final long serialVersionUID = -2005634319L; 
	...
	public Object clonar() {
		return new DCmdSrvConsDeclaracionContribucionParafiscalPatrocinador();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvConsDeclaracionContribucionParafiscalPatrocinador) {
			DCmdSrvConsDeclaracionContribucionParafiscalPatrocinador copia = (DCmdSrvConsDeclaracionContribucionParafiscalPatrocinador) comando;
