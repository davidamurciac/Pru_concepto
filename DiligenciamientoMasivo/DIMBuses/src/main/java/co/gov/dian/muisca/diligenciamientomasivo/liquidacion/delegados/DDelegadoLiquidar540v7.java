...
public class DDelegadoLiquidar540v7 extends DDelegadoLiquidar{

    public static Logger log = Logger.getLogger(DDelegadoLiquidar540v7.class);
    ...
    public String getDescripcion() {
        return "Delegado que implementa la Liquidación para el Formulario 540 versión 7.";
    }
  ...
  public IDDocumento liquidar(IDDocumento docLiquidacion) throws DExcepcion{
    ...
    private void efectuarLiquidacion() throws DExcepcion {
        ...
        /*Double valCasOtros = new Double(
            declaracion.getValorCasilla(33).getDouble() +
            declaracion.getValorCasilla(35).getDouble() +
            declaracion.getValorCasilla(37).getDouble()
        );*/
        ...
        /*Double valCasSanciones = new Double(
            declaracion.getValorCasilla(39).getDouble() +
            declaracion.getValorCasilla(41).getDouble()
        );
