 ...
 * </pre>
 */
public class DCmdSrvConsLstSolicitudConciliaPago extends DComandoServicioNegocio {


  /** Tipo de operaci� de consulta */
  protected int tipoOperacion = -1;
  /** Colecci� de objetos DSolicitudConciliaPagoTO */
  protected Collection objetosSolicitudConciliaPago;

  /**
   * Devuelve la colecci� de objetos SolicitudConciliaPago que se hayan consultado.
  ...
  public Object clonar() {
    return new DCmdSrvConsLstSolicitudConciliaPago();
  }
  ...
  public void asignar(IDComando comando) {
    if (comando instanceof DCmdSrvConsLstSolicitudConciliaPago) {
      DCmdSrvConsLstSolicitudConciliaPago copia = (DCmdSrvConsLstSolicitudConciliaPago) comando;
