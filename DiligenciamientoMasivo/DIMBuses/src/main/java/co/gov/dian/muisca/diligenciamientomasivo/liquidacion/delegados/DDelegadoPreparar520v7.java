 ...
 * @version 1.0
 */
public class DDelegadoPreparar520v7 extends DDelegadoPreparar {

	public static String anno_presentacion;

	public DDelegadoPreparar520v7() {
        try {
            jbInit();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Parámetros para la Liquidación del Formulario 520 versión 7");
