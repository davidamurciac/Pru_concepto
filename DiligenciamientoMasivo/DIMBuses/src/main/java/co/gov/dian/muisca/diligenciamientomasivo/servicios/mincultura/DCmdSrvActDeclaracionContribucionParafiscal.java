 ...
 * </pre>
 */
public class DCmdSrvActDeclaracionContribucionParafiscal extends DComandoServicioInterno {
	private static final long serialVersionUID = 159459918L; 
	 ...
	 * la actualización de DeclaracionContribucionParafiscal
	 */
	...
	public Object clonar() {
		return new DCmdSrvActDeclaracionContribucionParafiscal();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvActDeclaracionContribucionParafiscal) {
			DCmdSrvActDeclaracionContribucionParafiscal copia = (DCmdSrvActDeclaracionContribucionParafiscal) comando;
