 ...
 * <p>Descripcion: Comando de acción utilizado para consultar un objeto FormalizaBorradorDef.</p>
 ...
 * </pre>
 */
public class DCmdAccConsFormalizaBorradorDef extends DComandoAccion {
	private static final long serialVersionUID = -970693665L; 
	...
	public Object clonar() {
		return new DCmdAccConsFormalizaBorradorDef();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccConsFormalizaBorradorDef) {
			DCmdAccConsFormalizaBorradorDef copia = (DCmdAccConsFormalizaBorradorDef) comando;
