 ...
 * </pre>
 */
public class DCmdSrvConsDetRetContrArtEscenics extends DComandoServicioInterno {
	private static final long serialVersionUID = -1336354285L; 
	 ...
	 * la consulta de DetRetContrArtEscenics
	 */
	...
	public Object clonar() {
		return new DCmdSrvConsDetRetContrArtEscenics();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvConsDetRetContrArtEscenics) {
			DCmdSrvConsDetRetContrArtEscenics copia = (DCmdSrvConsDetRetContrArtEscenics) comando;
