...
//entradasalida.transferencias.DCmdAccConsolPreciosTransInd

public class DCmdAccConsolPreciosTransInd extends DComandoAccion {
    ...
    public DCmdAccConsolPreciosTransInd() {
    }
    ...
    public void asignar(IDComando comando) {
        if (comando instanceof DCmdAccConsolPreciosTransInd) {
            DCmdAccConsolPreciosTransInd copia;
            copia = (DCmdAccConsolPreciosTransInd) comando;
    ...
    public Object clonar() {
        return new DCmdAccConsolPreciosTransInd();
    }
