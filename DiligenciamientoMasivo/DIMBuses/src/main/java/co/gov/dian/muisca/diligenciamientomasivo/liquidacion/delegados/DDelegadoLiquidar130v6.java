...
public class DDelegadoLiquidar130v6 extends DDelegadoLiquidar{
    ...
    public String getDescripcion() {
        return "Delegado que implementa la Liquidación para el Formulario 130 versión 6.";
    }
...
private void efectuarLiquidacion() throws DEntradaSalidaExcepcion, DExcepcion {
    ...
    double declaracionPagoSancion = ocurrenciaDoc130.getValorCasilla(
            IDCasillasFormulario130.SANCIONES).getDouble();
