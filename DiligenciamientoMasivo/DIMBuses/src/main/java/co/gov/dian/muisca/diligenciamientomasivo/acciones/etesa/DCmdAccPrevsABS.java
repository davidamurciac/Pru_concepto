package co.gov.dian.muisca.diligenciamientomasivo.acciones.etesa;
...
/**
 * Comando de accion que permite operar sobre la tabla EYS_DOCUMENTOS_BAN_SALIDA, para registro de prevalidadores iniciales ETESA
 * 
 * @author nfontechar
 *
 */
public class DCmdAccPrevsABS extends DComandoAccion {
	...
	public void asignar(IDComando comando) {
		if(comando instanceof DCmdAccPrevsABS){
			DCmdAccPrevsABS copia=(DCmdAccPrevsABS) comando;
			copia.elTO=elTO;
			copia.laPK=laPK;
			copia.elAtt=elAtt;
			copia.losTOs=losTOs;
