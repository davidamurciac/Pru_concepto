...
public class DDelegadoLiquidar120v9 extends DDelegadoLiquidar{
   ...
   /**
    ...
    public String getDescripcion() {
        return "Delegado que implementa la Liquidaci�n para el Formulario 120 versi�n 9.";
    }
  ...
  public IDDocumento liquidar(IDDocumento docLiquidacion) throws DExcepcion{
      ...
      /**
       * Construye el Documento para el resultado de la liquidaci�n y llena
...
// Obtiene informaci�n de la declaraci�n.
...
// Ejecuta el Servicio para liquidaci�n de cuotas.
