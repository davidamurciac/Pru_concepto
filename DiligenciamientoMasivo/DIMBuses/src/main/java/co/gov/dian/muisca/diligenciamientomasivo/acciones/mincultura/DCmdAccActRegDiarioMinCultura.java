 ...
 * </pre>
 */
public class DCmdAccActRegDiarioMinCultura extends DComandoAccion {
	private static final long serialVersionUID = -1871871455L; 
	...
	public Object clonar() {
		return new DCmdAccActRegDiarioMinCultura();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccActRegDiarioMinCultura) {
			DCmdAccActRegDiarioMinCultura copia = (DCmdAccActRegDiarioMinCultura) comando;
