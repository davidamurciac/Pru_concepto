 ...
 * </pre>
 */
public class DCmdAccCrearDeclaracionContribucionParafiscalPatrocinador extends DComandoAccion {
	private static final long serialVersionUID = -497544731L; 
	...
	public Object clonar() {
		return new DCmdAccCrearDeclaracionContribucionParafiscalPatrocinador();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccCrearDeclaracionContribucionParafiscalPatrocinador) {
			DCmdAccCrearDeclaracionContribucionParafiscalPatrocinador copia = (DCmdAccCrearDeclaracionContribucionParafiscalPatrocinador) comando;
