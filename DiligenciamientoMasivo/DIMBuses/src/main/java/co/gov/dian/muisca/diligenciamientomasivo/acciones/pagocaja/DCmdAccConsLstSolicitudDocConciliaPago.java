 ...
 * <p>Descripcion: Comando de acci�n utilizado para consultar objetos SolicitudDocConciliaPago.</p>
 ...
 * </pre>
 */
public class DCmdAccConsLstSolicitudDocConciliaPago extends DComandoAccion {


  /** Tipo de operaci�n de consulta */
  protected int tipoOperacion = -1;
  /** Colecci�n de objetos DSolicitudDocConciliaPagoTO */
  protected Collection objetosSolicitudDocConciliaPago;

  /**
   * Devuelve la colecci�n de objetos SolicitudDocConciliaPago que se hayan consultado.
  ...
  public Object clonar() {
    return new DCmdAccConsLstSolicitudDocConciliaPago();
  }
  ...
  public void asignar(IDComando comando) {
    if (comando instanceof DCmdAccConsLstSolicitudDocConciliaPago) {
      DCmdAccConsLstSolicitudDocConciliaPago copia = (DCmdAccConsLstSolicitudDocConciliaPago) comando;
