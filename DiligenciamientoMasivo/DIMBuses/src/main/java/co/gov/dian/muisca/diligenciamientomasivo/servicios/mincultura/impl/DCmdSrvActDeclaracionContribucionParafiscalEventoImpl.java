 ...
 * </pre>
 */
public class DCmdSrvActDeclaracionContribucionParafiscalEventoImpl extends DCmdSrvActDeclaracionContribucionParafiscalEvento {

	private static final long serialVersionUID = -201176789L; 
	 ...
	 * actualización de DeclaracionContribucionParafiscalEvento
	 */
	protected void ejecutarComando() throws DExcepcion {
		...
		try {
			...
			// Actualizar
			dao.inicializarActualizar(toDeclaracionContribucionParafiscalEvento);
			admin.guardar(dao);
		}
		finally {
			admin.cerrarSesion();
