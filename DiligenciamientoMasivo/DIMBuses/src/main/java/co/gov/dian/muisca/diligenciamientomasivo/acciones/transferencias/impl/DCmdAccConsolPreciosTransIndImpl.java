...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.transferencias.DCmdAccConsolPreciosTransInd;
...
public class DCmdAccConsolPreciosTransIndImpl extends DCmdAccConsolPreciosTransInd {

    Logger logger = Logger.getLogger(DCmdAccConsolPreciosTransIndImpl.class);
    private final int CASILLA_ACCIONISTAS_RELACIONADOS = 29;
    private final int CASILLA_SOLICITUD_1124 = 48;
    ...
    /** */
    private static final int IDE_FORMATO = 1124;
    /** */
    private static final int NUM_VERSION = 6;

    private Logger LOGGER = Logger.getLogger(DCmdAccConsolPreciosTransIndImpl.class);
            ...
            while (documentosCargados != null && documentosCargados.size() > 0) {
                ...
                for (Iterator iter = documentosCargados.iterator(); iter.hasNext(); ) {
                    ...
                    porcentaje += (ocurrencia.getValorCasilla(CASILLA_31_1124) !=
                            ...
                            getValorCasilla(CASILLA_31_1124).getValorDecimal().longValue() : 0;
