...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.
  DCmdAccWFGenerarDecInformativaConsolidadaIndv7;
...
import co.gov.dian.muisca.diligenciamientomasivo.general.preciostransferencia.
  DHelperExpedienteGeneracion120v7;
import co.gov.dian.muisca.entradasalida.servicios.documentos.
  DCmdSrvCrearDocumentoES;
import org.apache.log4j.Logger;

public class DCmdAccWFGenerarDecInformativaConsolidadaIndv7Impl extends
  DCmdAccWFGenerarDecInformativaConsolidadaIndv7 {

  private static final Logger logger = Logger.getLogger(
        DCmdAccWFGenerarDecInformativaConsolidadaIndv7Impl.class);
  ...
  private static final int CASILLA_MONTO_TOTAL_OPERACIONES_INGRESO = 29;
  private static final int CASILLA_MONTO_TOTAL_OPERACIONES_EGRESO = 30;
  private static final int CASILLA_MONTO_MOVIMIENTO_ACTIVO_DEBITO = 31;
  private static final int CASILLA_MONTO_MOVIMIENTO_ACTIVO_CREDITO = 32;
  private static final int CASILLA_MONTO_SALDO_ACTIVO_FINAL = 33;
  private static final int CASILLA_MONTO_MOVIMIENTO_PASIVO_DEBITO = 34;
  private static final int CASILLA_MONTO_MOVIMIENTO_PASIVO_CREDITO = 35;
  private static final int CASILLA_MONTO_SALDO_PASIVO_FINAL = 36;
  private static final int CASILLA_SOLICITUD_ENVIO_1125 = 48;
  private static final int CASILLA_BASE_LIQUIDACION = 45;
  private static final int CASILLA_SANCION = 46;
  ...
  static final String URL =
    "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv7.faces";
  ...
  //Helpers
  private DHelperExpedienteGeneracion120v7 manejadorExpedientes = null;

  public DCmdAccWFGenerarDecInformativaConsolidadaIndv7Impl() {
  }
  ...
  protected void ejecutarComandoSinTransaccion() {
    logger.info("Inicio WF Decl. Inf. Precios de Transferencia Individual v7");
          ...
          while (documentosCargados != null && documentosCargados.size() > 0) {
            ...
            for (Iterator iter = documentosCargados.iterator(); iter.hasNext(); ) {
              ...
              if (ocurrencia.getValorCasilla(CASILLA_31_1125) != null &&
                ...
                //casilla 31 casilla 32, casilla 33 del 120 ver 7
                ...
                //casilla 34, casilla 35, casilla 36 del 120 ver 7
    ...
    if (unaSolicitud.getSolicitudAtt().getNumeroDocumentoAnterior() != null) {
      ...
      if (solExogena != null) {
        ...
        if (consDocGenExogena.getDocGenExogena().
          ...
          tipoError = ERROR_DOC_120_ANTERIOR_NO_PRESENTADO;
  ...
  protected void ejecutarComandoWF() {
    try {
      if (procesarValido) {
        ...
        ocurrencia.getValorCasilla(CASILLA_SANCION).
          setValor("0");
  ...
  private DHelperExpedienteGeneracion120v7 getManejadorExpedientes() {
    if (manejadorExpedientes == null) {
      manejadorExpedientes =
        new DHelperExpedienteGeneracion120v7(this);
    }
  ...
  private Long notificarResponsable(DSolicitudIngresoTO miSolicitud,
    ...
    msjNotificacion += Long.toString(identificadorDoc.getIdDocumento());
      urlTarea = "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv7.faces";
    }
  ...
  private DIdentificadorDoc salvarDocumento(IDDocumento doc) throws
    DExcepcion {
	 ...
	 String xml = DDocumentoUtil.obtenerXmlDeDocumento(doc);
