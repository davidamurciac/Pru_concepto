 ...
 * @version 1.0
 */
public class DDelegadoPreparar120v9 extends DDelegadoPreparar {
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Par�metros para la Liquidaci�n del Formulario 120 versi�n 8");
