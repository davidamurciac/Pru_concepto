 ...
 * </pre>
 */
public class DCmdAccConsLstDeclaracionContribucionParafiscalEvento extends DComandoAccion {
	private static final long serialVersionUID = -1751685289L; 
	...
	public Object clonar() {
		return new DCmdAccConsLstDeclaracionContribucionParafiscalEvento();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccConsLstDeclaracionContribucionParafiscalEvento) {
			DCmdAccConsLstDeclaracionContribucionParafiscalEvento copia = (DCmdAccConsLstDeclaracionContribucionParafiscalEvento) comando;
