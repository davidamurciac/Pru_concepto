 ...
 * </pre>
 */
public class DCmdAccActDeclaracionContribucionParafiscalEvento extends DComandoAccion {
	private static final long serialVersionUID = 1121305784L; 
	...
	public Object clonar() {
		return new DCmdAccActDeclaracionContribucionParafiscalEvento();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccActDeclaracionContribucionParafiscalEvento) {
			DCmdAccActDeclaracionContribucionParafiscalEvento copia = (DCmdAccActDeclaracionContribucionParafiscalEvento) comando;
