...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.
  DCmdAccWFGenerarDecInformativaConsolidadaIndv9;
...
import co.gov.dian.muisca.diligenciamientomasivo.general.preciostransferencia.
  DHelperExpedienteGeneracion120v9;
import co.gov.dian.muisca.entradasalida.servicios.documentos.
...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv9Impl extends 
  DCmdAccWFGenerarDecInformativaConsolidadaIndv9 {

  private static final Logger logger = Logger.getLogger(
    DCmdAccWFGenerarDecInformativaConsolidadaIndv9Impl.class);
  ...
  private static final int NUM_VERSION_FORMATO = 9;
  ...
  static final String URL =
    "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv9.faces";
  ...
  //Helpers
  private DHelperExpedienteGeneracion120v9 manejadorExpedientes = null;

  public DCmdAccWFGenerarDecInformativaConsolidadaIndv9Impl() {
  }
  ...
  protected void ejecutarComandoSinTransaccion() {
    logger.info("Inicio WF Decl. Inf. Precios de Transferencia Individual v9");
  ...
  private DHelperExpedienteGeneracion120v9 getManejadorExpedientes() {
    if (manejadorExpedientes == null) {
      manejadorExpedientes =
        new DHelperExpedienteGeneracion120v9(this);
    }
  ...
  private Long notificarResponsable(DSolicitudIngresoTO miSolicitud,
    ...
    if (procesarValido) {
      ...
      //urlTarea = "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv9.faces";
    }
