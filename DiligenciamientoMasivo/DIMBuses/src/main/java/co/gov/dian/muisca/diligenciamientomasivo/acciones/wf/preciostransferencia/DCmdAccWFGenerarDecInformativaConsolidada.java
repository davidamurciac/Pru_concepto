...
/**
 * <p>Title: DCmdAccWFGenerarDecInformativaConsolidada</p>
 ...
 * @version 1.0
 */
public class DCmdAccWFGenerarDecInformativaConsolidada extends DComandoWF {

    /*Atributos*/
    protected static Logger LOGGER = Logger.getLogger(
            DCmdAccWFGenerarDecInformativaConsolidada.class);
    ...
    protected int repeticionDocCorreccion = 0;
    ...
    public DCmdAccWFGenerarDecInformativaConsolidada() {
    }
    ...
    protected void asignarWF(IDComando comando) {
        if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidada){
            DCmdAccWFGenerarDecInformativaConsolidada copia = (DCmdAccWFGenerarDecInformativaConsolidada)comando;
    ...
    public Object clonar() {
        return new DCmdAccWFGenerarDecInformativaConsolidada();
    }
