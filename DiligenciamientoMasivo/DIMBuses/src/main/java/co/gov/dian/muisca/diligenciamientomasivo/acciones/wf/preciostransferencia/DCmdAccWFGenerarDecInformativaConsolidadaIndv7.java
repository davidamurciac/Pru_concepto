...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv7 extends DComandoWF {

    /*Atributos*/
    protected static Logger logger = Logger.getLogger(
            DCmdAccWFGenerarDecInformativaConsolidadaIndv7.class);
    ...
    public DCmdAccWFGenerarDecInformativaConsolidadaIndv7() {
    }
    ...
    protected void asignarWF(IDComando comando) {
        if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidadaIndv7){
            DCmdAccWFGenerarDecInformativaConsolidadaIndv7 copia = (DCmdAccWFGenerarDecInformativaConsolidadaIndv7)comando;
            ...
            copia.montoOperacion= montoOperacion; //cas4
    ...
    public Object clonar() {
        return new DCmdAccWFGenerarDecInformativaConsolidadaIndv7();
    }
    ...
    public String getDescripcion() {
        return "Comando WF que genera una declaraci�n 120 Version 7";
    }
