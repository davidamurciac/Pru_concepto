...
public class DDelegadoLiquidar570v9 extends DDelegadoLiquidar{

    public static Logger log = Logger.getLogger(DDelegadoLiquidar570v9.class);
    ...
    public String getDescripcion() {
        return "Delegado que implementa la Liquidación para el Formulario 570 versión 9.";
    }
