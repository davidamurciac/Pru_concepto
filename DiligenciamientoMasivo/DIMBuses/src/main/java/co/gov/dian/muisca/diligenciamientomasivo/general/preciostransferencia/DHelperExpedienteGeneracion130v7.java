 ...
 *
 * $Header: DHelperExpedienteGeneracion130v7.java, 3, 2/3/09 7:28:20 PM COT, ARMANDO PEREA MORA$
 */
...
public class DHelperExpedienteGeneracion130v7 extends DHelperExpedienteGeneracion130 {
	//~--- Campos Estaticos -

	private static final Logger logger = Logger.getLogger(DHelperExpedienteGeneracion130v7.class);
	 ...
	 */
	public DHelperExpedienteGeneracion130v7(DComandoAplicacion comando) {
		super(comando);
	}
	...
	protected void inicializarVariablesInternas() {
		...
		setIdeTareaDiligenciarDec(new Long(ids.IDE_TAREA_DILIGENCIAR_DECLARACION_CONSOLIDADA_V7));

		setIdeParTareaIdeDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_DOC_DECLARACION_CONSOLIDADA_V7));
		setIdeParTareaNumRepDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_NUM_REP_DOC_DECLARACION_CONSOLIDADA_V7));
		setIdeParTareaIdeDocSolicitud(new Integer(ids.IDE_PAR_TAREA_DOC_SOLICITUD_CONSOLIDADA_V7));
		setIdeParTareaEsRepeticion(new Integer(ids.IDE_PAR_TAREA_ES_REPETICION_CONSOLIDADA_V7));
	}
