...
//entradasalida.transferencias.DCmdAccConsolPreciosTransIndv7

public class DCmdAccConsolPreciosTransIndv7 extends DComandoAccion {
    ...
    public DCmdAccConsolPreciosTransIndv7() {
    }
    ...
    public void asignar(IDComando comando) {
        if (comando instanceof DCmdAccConsolPreciosTransIndv7) {
            DCmdAccConsolPreciosTransIndv7 copia;
            copia = (DCmdAccConsolPreciosTransIndv7) comando;
    ...
    public Object clonar() {
        return new DCmdAccConsolPreciosTransIndv7();
    }
