 ...
 * </pre>
 */
public class DCmdSrvConsRegDiarioMinCultura extends DComandoServicioInterno {
	private static final long serialVersionUID = 820292545L; 
	...
	public Object clonar() {
		return new DCmdSrvConsRegDiarioMinCultura();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvConsRegDiarioMinCultura) {
			DCmdSrvConsRegDiarioMinCultura copia = (DCmdSrvConsRegDiarioMinCultura) comando;
