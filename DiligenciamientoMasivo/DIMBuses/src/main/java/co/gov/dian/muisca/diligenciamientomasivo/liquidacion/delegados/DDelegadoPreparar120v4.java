 ...
 * @version 1.0
 */
public class DDelegadoPreparar120v4 extends DDelegadoPreparar {
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Parámetros para la Liquidación del Formulario 120 versión ");
        metaLiquidacion.setIdPersonaRut(idPersonaRut);
        metaLiquidacion.setIdFormatoDocIn(120);
        metaLiquidacion.setVersionFtoDocIn(4);
