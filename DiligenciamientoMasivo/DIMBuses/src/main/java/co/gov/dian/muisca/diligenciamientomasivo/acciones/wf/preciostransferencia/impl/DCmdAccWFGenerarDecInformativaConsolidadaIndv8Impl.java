...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.
  DCmdAccWFGenerarDecInformativaConsolidadaIndv8;
...
import co.gov.dian.muisca.diligenciamientomasivo.general.preciostransferencia.
  DHelperExpedienteGeneracion120v8;
import co.gov.dian.muisca.entradasalida.servicios.documentos.
...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv8Impl extends
  DCmdAccWFGenerarDecInformativaConsolidadaIndv8 {

  private static final Logger logger = Logger.getLogger(
    DCmdAccWFGenerarDecInformativaConsolidadaIndv8Impl.class);
  ...
  private static final int NUM_VERSION_FORMATO = 8;
  ...
  static final String URL =
    "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv8.faces";
  ...
  //Helpers
  private DHelperExpedienteGeneracion120v8 manejadorExpedientes = null;

  public DCmdAccWFGenerarDecInformativaConsolidadaIndv8Impl() {
  }
  ...
  protected void ejecutarComandoSinTransaccion() {
    logger.info("Inicio WF Decl. Inf. Precios de Transferencia Individual v8");
          ...
          while (documentosCargados != null && documentosCargados.size() > 0) {
            ...
            for (Iterator iter = documentosCargados.iterator(); iter.hasNext(); ) {
              ...
              if (ocurrencia.getValorCasilla(CASILLA_31_1125) != null &&
                ...
                //casilla 31 casilla 32, casilla 33 del 120 ver 8
  ...
  public boolean validarDocCorreccion(DSolicitudIngresoTO unaSolicitud) throws
    ...
    boolean esCorreccion = false;
		...
		if (unaSolicitud.getSolicitudAtt().getNumeroDocumentoAnterior() != null) {
			...
			while ((solExogena == null) && (ideSolicitudAnterior != null) && (ideSolicitudAnterior.longValue() > 0)) {
  ...
  private DHelperExpedienteGeneracion120v8 getManejadorExpedientes() {
    if (manejadorExpedientes == null) {
      manejadorExpedientes =
        new DHelperExpedienteGeneracion120v8(this);
    }
  ...
  private Long notificarResponsable(DSolicitudIngresoTO miSolicitud,
    ...
    if (procesarValido) {
      ...
      //urlTarea = "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv8.faces";
    }
