...
import co.gov.dian.muisca.diligenciamientomasivo.liquidacion.IDCasillasFormulario120;
import co.gov.dian.muisca.diligenciamiento.liquidacion.delegados.DDelegadoLiquidar;
import co.gov.dian.muisca.diligenciamiento.liquidacion.impl.DCalculosLiqF490V6;
...
public class DDelegadoLiquidar120v6 extends DDelegadoLiquidar{
   ...
   /**
    ...
    public String getDescripcion() {
        return "Delegado que implementa la Liquidación para el Formulario 120 versión 7.";
    }
  ...
  public IDDocumento liquidar(IDDocumento docLiquidacion) throws DExcepcion{
      ...
      DCalculosLiqF490V6.copiaValoresDefinicion(docLiquidacion, docLiquidado,
                                              metaLiquidacion, contextoSeg);
      efectuarLiquidacion();
      DCalculosLiqF490V6.calcularPagoTotal(docLiquidado);
      DCalculosLiqF490V6.eliminarCeros(docLiquidado);
      return docLiquidado;
...
// Obtiene información de la declaración.
    ...
    double declaracionPagoSancion = ocurrenciaDoc120.getValorCasilla(
            IDCasillasFormulario120.CASILLA_SANCIONES).getDouble();
...
// Ejecuta el Servicio para liquidación de cuotas.
    ...
    /*if(!isFraccion){
        ...
        DCalculosLiqF490V6.asignarValoresDocLiquidado(
