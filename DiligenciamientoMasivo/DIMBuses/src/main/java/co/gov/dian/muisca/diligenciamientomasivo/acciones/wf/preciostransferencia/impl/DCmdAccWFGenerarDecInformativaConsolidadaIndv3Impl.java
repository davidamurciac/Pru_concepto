...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.DCmdAccWFGenerarDecInformativaConsolidadaIndv3;
...
import co.gov.dian.muisca.diligenciamientomasivo.general.preciostransferencia.DHelperExpedienteGeneracion120v3;
...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv3Impl extends DCmdAccWFGenerarDecInformativaConsolidadaIndv3 {
	...
	private static final Logger logger = Logger.getLogger(
			DCmdAccWFGenerarDecInformativaConsolidadaIndv3Impl.class);
	...
	private static final int NUM_VERSION_FORMATO = 3;
	 ...
	 */
	static final String URL = "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv3.faces";
	...
	//Helpers
	private DHelperExpedienteGeneracion120v3 manejadorExpedientes = null;

	public DCmdAccWFGenerarDecInformativaConsolidadaIndv3Impl() {
	}
	...
	protected void ejecutarComandoSinTransaccion() {
		logger.info("Inicio WF Decl. Inf. Precios de Transferencia Individual v3");
					...
					while (documentosCargados != null && documentosCargados.size() > 0) {
						...
						for (Iterator iter = documentosCargados.iterator(); iter.hasNext(); ) {
							...
							if (ocurrencia.getValorCasilla(CASILLA_31_1125) != null && ocurrencia.getValorCasilla(CASILLA_31_1125).getValorEntero() != null) {
								...
								//casilla 34, casilla 35, casilla 36 del 120 ver 3
	...
	protected void ejecutarComandoWF() {
		...
		logger.info("Finalizada ejecucion del WF Decl. Inf. Precios de " + "Transferencia Individual v3");
	}
	 ...
	 * @return
	 */
	private DHelperExpedienteGeneracion120v3 getManejadorExpedientes() {
