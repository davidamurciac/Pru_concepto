...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.DCmdAccWFGenerarDecInformativaConsolidadaIndv10;
...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv10Impl extends DCmdAccWFGenerarDecInformativaConsolidadaIndv10 {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2822166214775636835L;

	private static final Logger logger = Logger.getLogger(
			DCmdAccWFGenerarDecInformativaConsolidadaIndv10Impl.class);
	...
	private static final int NUM_VERSION_FORMATO = 10;
	 ...
	 */
	static final String URL = "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv10.faces";
	...
	//Helpers
	private DHelperExpedienteGeneracion120v10 manejadorExpedientes = null;

	public DCmdAccWFGenerarDecInformativaConsolidadaIndv10Impl() {
	}
	...
	protected void ejecutarComandoSinTransaccion() {
		logger.info("Inicio WF Decl. Inf. Precios de Transferencia Individual v10");
	...
	protected void ejecutarComandoWF() {
		...
		logger.info("Finalizada ejecucion del WF Decl. Inf. Precios de " + "Transferencia Individual v10");
	}
