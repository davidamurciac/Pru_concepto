 ...
 * </pre>
 */
public class DCmdAccConsLstRegDiarioMinCultura extends DComandoAccion {
	private static final long serialVersionUID = -710055360L; 
	...
	public Object clonar() {
		return new DCmdAccConsLstRegDiarioMinCultura();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccConsLstRegDiarioMinCultura) {
			DCmdAccConsLstRegDiarioMinCultura copia = (DCmdAccConsLstRegDiarioMinCultura) comando;
