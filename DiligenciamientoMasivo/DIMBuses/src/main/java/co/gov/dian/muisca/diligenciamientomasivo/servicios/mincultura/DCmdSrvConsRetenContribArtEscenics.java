 ...
 * </pre>
 */
public class DCmdSrvConsRetenContribArtEscenics extends DComandoServicioInterno {
	private static final long serialVersionUID = -1809848280L; 
	...
	public Object clonar() {
		return new DCmdSrvConsRetenContribArtEscenics();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvConsRetenContribArtEscenics) {
			DCmdSrvConsRetenContribArtEscenics copia = (DCmdSrvConsRetenContribArtEscenics) comando;
