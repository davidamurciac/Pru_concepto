 ...
 * </pre>
 */
public class DCmdSrvConsDetRegDiaMinculturaImpl extends DCmdSrvConsDetRegDiaMincultura {

	private static final long serialVersionUID = 1078386532L; 

	/**
	 * Ejecuta el comando de servicio.
	 *
	 * @throws DExcepcion Si ocurre algn error al realizar la
	 * consulta de DetRegDiaMincultura
	 */
	protected void ejecutarComando() throws DExcepcion {
		...
		try {
			...
			// Consultar
			dao.inicializarConsultarPorPK(pkDetRegDiaMincultura);
			admin.buscar(dao);
			toDetRegDiaMincultura = dao.getDetRegDiaMincultura();
		}
		finally {
			admin.cerrarSesion();
		}
