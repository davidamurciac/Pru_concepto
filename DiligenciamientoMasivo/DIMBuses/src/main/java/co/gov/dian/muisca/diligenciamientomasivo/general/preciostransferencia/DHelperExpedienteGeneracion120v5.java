 ...
 *
 * $Header: DHelperExpedienteGeneracion120v5.java, 2, 2/3/09 7:27:35 PM COT, ARMANDO PEREA MORA$
 */
...
public class DHelperExpedienteGeneracion120v5 extends DHelperExpedienteGeneracion120 {
	//~--- Campos Estaticos -

	private static final Logger logger = Logger.getLogger(DHelperExpedienteGeneracion120v5.class);
	 ...
	 */
	public DHelperExpedienteGeneracion120v5(DComandoAplicacion comando) {
		super(comando);
	}
	...
	protected void inicializarVariablesInternas() {
		...
		setIdeTareaDiligenciarDec(new Long(ids.IDE_TAREA_DILIGENCIAR_DECLARACION_INDIVIDUAL_V5));

		setIdeParTareaIdeDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_DOC_DECLARACION_INDIVIDUAL_V5));
		setIdeParTareaNumRepDocDeclaracion(new Integer(ids.IDE_PAR_TAREA_NUM_REP_DOC_DECLARACION_INDIVIDUAL_V5));
		setIdeParTareaIdeDocSolicitud(new Integer(ids.IDE_PAR_TAREA_DOC_SOLICITUD_INDIVIDUAL_V5));
		setIdeParTareaEsRepeticion(new Integer(ids.IDE_PAR_TAREA_ES_REPETICION_INDIVIDUAL_V5));
	}
