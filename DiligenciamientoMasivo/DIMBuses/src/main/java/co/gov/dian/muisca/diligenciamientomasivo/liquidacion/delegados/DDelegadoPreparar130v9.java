 ...
 * @version 1.0
 */
public class DDelegadoPreparar130v9 extends DDelegadoPreparar {
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Par�metros para la Liquidaci�n del Formulario 130 versi�n 9.");
