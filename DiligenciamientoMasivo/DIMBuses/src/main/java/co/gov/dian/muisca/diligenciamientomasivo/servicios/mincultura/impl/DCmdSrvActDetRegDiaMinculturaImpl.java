 ...
 * </pre>
 */
public class DCmdSrvActDetRegDiaMinculturaImpl extends DCmdSrvActDetRegDiaMincultura {

	private static final long serialVersionUID = -495119137L; 
	 ...
	 * actualización de DetRegDiaMincultura
	 */
	protected void ejecutarComando() throws DExcepcion {
		...
		try {
			...
			// Actualizar
			dao.inicializarActualizar(toDetRegDiaMincultura);
			admin.guardar(dao);
		}
		finally {
			admin.cerrarSesion();
