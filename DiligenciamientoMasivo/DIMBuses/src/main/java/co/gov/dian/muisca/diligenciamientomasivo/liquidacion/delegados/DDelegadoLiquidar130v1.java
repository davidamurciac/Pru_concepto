...
public class DDelegadoLiquidar130v1 extends DDelegadoLiquidar{
    ...
    public String getDescripcion() {
        return "Delegado que implementa la Liquidaciónn para el Formulario 130 versión 1.";
    }
  ...
  public IDDocumento liquidar(IDDocumento docLiquidacion) throws DExcepcion{
    ...
    /**
     * Construye el Documento para el resultado de la liquidaciï¿½n y llena
...
private void efectuarLiquidacion() throws DEntradaSalidaExcepcion, DExcepcion {
    ...
    // Obtiene informaciï¿½n de la declaraciï¿½n.
    ...
    // Ejecuta el Servicio para liquidaciï¿½n de cuotas.
