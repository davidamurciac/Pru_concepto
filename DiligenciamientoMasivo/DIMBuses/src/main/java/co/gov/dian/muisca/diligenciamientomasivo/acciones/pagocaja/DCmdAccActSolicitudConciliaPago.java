 ...
 * </pre>
 */
public class DCmdAccActSolicitudConciliaPago extends DComandoAccion {
  ...
  public Object clonar() {
    return new DCmdAccActSolicitudConciliaPago();
  }
  ...
  public void asignar(IDComando comando) {
    if (comando instanceof DCmdAccActSolicitudConciliaPago) {
      DCmdAccActSolicitudConciliaPago copia = (DCmdAccActSolicitudConciliaPago) comando;
