 ...
 * </pre>
 */
public class DCmdSrvConsLstDeclaracionContribucionParafiscal extends DComandoServicioInterno {
	private static final long serialVersionUID = -1778088380L; 
	...
	public Object clonar() {
		return new DCmdSrvConsLstDeclaracionContribucionParafiscal();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvConsLstDeclaracionContribucionParafiscal) {
			DCmdSrvConsLstDeclaracionContribucionParafiscal copia = (DCmdSrvConsLstDeclaracionContribucionParafiscal) comando;
