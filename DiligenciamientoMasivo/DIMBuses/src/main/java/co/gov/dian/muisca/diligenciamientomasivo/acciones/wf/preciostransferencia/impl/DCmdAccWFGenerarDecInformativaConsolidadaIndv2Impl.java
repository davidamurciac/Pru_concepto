...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.DCmdAccWFGenerarDecInformativaConsolidadaIndv2;
...
import co.gov.dian.muisca.diligenciamientomasivo.general.preciostransferencia.DHelperExpedienteGeneracion120v2;
...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv2Impl extends DCmdAccWFGenerarDecInformativaConsolidadaIndv2 {
	...
	private static final Logger logger = Logger.getLogger(
			DCmdAccWFGenerarDecInformativaConsolidadaIndv2Impl.class);

	//MENSAJES DE ERROR
	private final String ERROR_DOC_INICIAL_EXISTE = "Ya existe una declaracion INICIAL para el a�o gravable. " + "No es posible presentar la declaraci�n ";
	...
	private static final int NUM_VERSION_FORMATO = 2;
	 ...
	 */
	static final String URL = "/WebDiligenciamientomasivo/DefPreciosTransIndivPopUpv2.faces";
	...
	//Helpers
	private DHelperExpedienteGeneracion120v2 manejadorExpedientes = null;

	public DCmdAccWFGenerarDecInformativaConsolidadaIndv2Impl() {
	}
	...
	protected void ejecutarComandoSinTransaccion() {
		logger.info("Inicio WF Decl. Inf. Precios de Transferencia Individual v2");
					...
					while (documentosCargados != null && documentosCargados.size() > 0) {
						...
						for (Iterator iter = documentosCargados.iterator(); iter.hasNext(); ) {
							...
							if (ocurrencia.getValorCasilla(CASILLA_31_1125) != null && ocurrencia.getValorCasilla(CASILLA_31_1125).getValorEntero() != null) {
								...
								//casilla 34, casilla 35, casilla 36 del 120 ver 2
	...
	protected void ejecutarComandoWF() {
		...
		logger.info("Finalizada ejecucion del WF Decl. Inf. Precios de " + "Transferencia Individual v2");
	}
	 ...
	 * @return
	 */
	private DHelperExpedienteGeneracion120v2 getManejadorExpedientes() {
	...
	private IDDocumento dehomologar(IDDocumento documento) throws DExcepcion {
		...
		if (logDocumento.getConteo() > 0) {
			String mensaje = "El Documento " + documento.getId() + " con repetici�n " + documento.getRepeticion() + " no se ha podido ";
