...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv1 extends DComandoWF {

    /*Atributos*/
    protected static Logger logger = Logger.getLogger(
            DCmdAccWFGenerarDecInformativaConsolidadaIndv1.class);
    ...
    public DCmdAccWFGenerarDecInformativaConsolidadaIndv1() {
    }
    ...
    protected void asignarWF(IDComando comando) {
        if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidadaIndv1){
            DCmdAccWFGenerarDecInformativaConsolidadaIndv1 copia = (DCmdAccWFGenerarDecInformativaConsolidadaIndv1)comando;
    ...
    public Object clonar() {
        return new DCmdAccWFGenerarDecInformativaConsolidadaIndv1();
    }
    ...
    public String getDescripcion() {
        return "Comando WF que genera una declaraci�n 120 Version 1";
    }
