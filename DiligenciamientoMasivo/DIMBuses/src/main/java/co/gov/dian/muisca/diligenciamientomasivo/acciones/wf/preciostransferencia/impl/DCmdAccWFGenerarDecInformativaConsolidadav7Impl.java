...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.DCmdAccWFGenerarDecInformativaConsolidadav7;
 ...
 * @version 1.0
 */
public class DCmdAccWFGenerarDecInformativaConsolidadav7Impl extends
  DCmdAccWFGenerarDecInformativaConsolidadav7 {

  private static final Logger logger = Logger.getLogger(
        DCmdAccWFGenerarDecInformativaConsolidadav7Impl.class);
...
//Casillas del 120 para matriz
  ...
  private static final int VERSION_FORMATO = 7;
  ...
  public DCmdAccWFGenerarDecInformativaConsolidadav7Impl() {
  }
  ...
  protected void ejecutarComandoSinTransaccion() {
    logger.info("Inicio WF Decl. Inf. Precios de Transferencia Consolidada v7");
...
// Manejo de individual para matriz
        ...
        if (annoSolicitud > 2006 && annoSolicitud < 2008)
            version120 = 8;
        if(annoSolicitud >= 2008)
        	version120 = 9;
        ...
        if (idenDoc != null) {
          ...
          ocurrencia.getValorCasilla(CASILLA_PASIVO_MOVIMIENTO_CREDITO_OBLIGADO).
            ...
            getValorEntero());
          ocurrencia.getValorCasilla(CASILLA_PASIVO_SALDO_OBLIGADO).
            setValor(ocurrenciaInd.getValorCasilla(CASILLA_36_120).
            getValorEntero());
          }
...
// Se setean estos valores por que son obligatorios y tipo entrada 5 esta estricto S
  ...
  private Long notificarResponsable(DSolicitudIngresoTO miSolicitud,
      ...
      if (procesarValido) {
          ...
          urlTarea = "/WebDiligenciamientomasivo/DefPreciosTransConsolidadav7.faces";
      }
  ...
  private IDDocumento obtenerDocumentoMUISCA(long ideDocumento,
		    ...
		    DCmdSrvConsDocumentoMUISCA srvConsDoc = (DCmdSrvConsDocumentoMUISCA)
		      getServicio("entradasalida.documentos.DCmdSrvConsDocumentoMUISCA");
