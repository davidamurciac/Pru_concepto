 ...
 * <p>Descripcion: Comando de acción utilizado para crear un objeto DeclaracionContribucionParafiscal.</p>
 ...
 * </pre>
 */
public class DCmdAccCrearDeclaracionContribucionParafiscal extends DComandoAccion {
	private static final long serialVersionUID = -999369641L; 
	...
	public Object clonar() {
		return new DCmdAccCrearDeclaracionContribucionParafiscal();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccCrearDeclaracionContribucionParafiscal) {
			DCmdAccCrearDeclaracionContribucionParafiscal copia = (DCmdAccCrearDeclaracionContribucionParafiscal) comando;
