 ...
 * @version 1.0
 */
public class DDelegadoPreparar130v1 extends DDelegadoPreparar {
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Parámetros para la Liquidación del Formulario 130 versión 1.");
