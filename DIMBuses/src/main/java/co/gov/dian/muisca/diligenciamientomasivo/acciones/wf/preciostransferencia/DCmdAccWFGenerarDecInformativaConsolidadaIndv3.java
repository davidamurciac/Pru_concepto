...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv3 extends DComandoWF {

    /*Atributos*/
    protected static Logger logger = Logger.getLogger(
            DCmdAccWFGenerarDecInformativaConsolidadaIndv3.class);
    ...
    public DCmdAccWFGenerarDecInformativaConsolidadaIndv3() {
    }
    ...
    protected void asignarWF(IDComando comando) {
        if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidadaIndv3){
            DCmdAccWFGenerarDecInformativaConsolidadaIndv3 copia = (DCmdAccWFGenerarDecInformativaConsolidadaIndv3)comando;
    ...
    public Object clonar() {
        return new DCmdAccWFGenerarDecInformativaConsolidadaIndv3();
    }
    ...
    public String getDescripcion() {
        return "Comando WF que genera una declaraci�n 120 Version 3";
    }
