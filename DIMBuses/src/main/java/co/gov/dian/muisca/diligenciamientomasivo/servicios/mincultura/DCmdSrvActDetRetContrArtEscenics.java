 ...
 * </pre>
 */
public class DCmdSrvActDetRetContrArtEscenics extends DComandoServicioInterno {
	private static final long serialVersionUID = -1474315256L; 
	 ...
	 * la actualización de DetRetContrArtEscenics
	 */
	...
	public Object clonar() {
		return new DCmdSrvActDetRetContrArtEscenics();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvActDetRetContrArtEscenics) {
			DCmdSrvActDetRetContrArtEscenics copia = (DCmdSrvActDetRetContrArtEscenics) comando;
