 ...
 * </pre>
 */
public class DCmdSrvElimDeclaracionContribucionParafiscalImpl extends DCmdSrvElimDeclaracionContribucionParafiscal {

	private static final long serialVersionUID = 2029867169L; 
	 ...
	 * consulta de DeclaracionContribucionParafiscal o si el objeto no existe
	 */
	protected void ejecutarComando() throws DExcepcion {
		...
		try {
			...
			// Eliminar
			dao.inicializarEliminar(pkDeclaracionContribucionParafiscal);
			admin.eliminar(dao);
		}
		finally {
			admin.cerrarSesion();
