 ...
 * </pre>
 */
public class DCmdSrvElimDeclaracionContribucionParafiscalPatrocinadorImpl extends DCmdSrvElimDeclaracionContribucionParafiscalPatrocinador {

	private static final long serialVersionUID = -1695781073L; 
	 ...
	 * consulta de DeclaracionContribucionParafiscalPatrocinador o si el objeto no existe
	 */
	protected void ejecutarComando() throws DExcepcion {
		...
		try {
			...
			if(tipoOperacion ==ELIMINAR) {
				dao.inicializarEliminar(pkDeclaracionContribucionParafiscalPatrocinador);
			} else if(tipoOperacion ==ELIMINAR_POR_DECLARACIONCONTRIBUCIONPARAFISCAL) {
				dao.inicializarEliminarPorDeclaracionContribucionParafiscal(pkDeclaracionContribucionParafiscal);
			}  
			admin.eliminar(dao);
		}
		finally {
