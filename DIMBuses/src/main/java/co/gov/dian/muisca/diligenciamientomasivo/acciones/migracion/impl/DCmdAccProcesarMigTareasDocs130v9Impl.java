 ...
 *
 * $Header: DCmdAccProcesarMigTareasDocs130v9Impl.java, 4, 1/31/08 3:14:53 PM COT, ARMANDO PEREA MORA$
 */
...
public class DCmdAccProcesarMigTareasDocs130v9Impl extends
  DCmdAccProcesarMigTareasDocs130v9 {
  private static final Logger logger = Logger.getLogger(
    DCmdAccProcesarMigTareasDocs130v9Impl.class);

  public DCmdAccProcesarMigTareasDocs130v9Impl() {
  }
  ...
  private void procesarDocumento(Long ideDocumento,
    ...
    try {
      ...
      DCmdAccMigTareasDoc130v9 cmdAccMig = (DCmdAccMigTareasDoc130v9)
        getAccionOtroContexto(
        "diligenciamientomasivo.migracion.DCmdAccMigTareasDoc130v9", true);
