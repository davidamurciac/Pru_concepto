...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.transferencias.DCmdAccConsolPreciosTransIndv7;
...
public class DCmdAccConsolPreciosTransIndv7Impl extends DCmdAccConsolPreciosTransIndv7{

    Logger logger = Logger.getLogger(DCmdAccConsolPreciosTransIndv7Impl.class);
    ...
    private Logger LOGGER = Logger.getLogger(DCmdAccConsolPreciosTransIndv7Impl.class);

    /** */
    private static final int IDE_FORMATO = 120;
    /** */
    private static final int NUM_VERSION = 7;
