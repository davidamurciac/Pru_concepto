 ...
 * <p>Descripcion: Comando de servicio utilizado para consultar un objeto DetRegDiaMincultura.</p>
 ...
 * </pre>
 */
public class DCmdSrvConsDetRegDiaMincultura extends DComandoServicioInterno {
	private static final long serialVersionUID = -525516148L; 
	...
	public Object clonar() {
		return new DCmdSrvConsDetRegDiaMincultura();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvConsDetRegDiaMincultura) {
			DCmdSrvConsDetRegDiaMincultura copia = (DCmdSrvConsDetRegDiaMincultura) comando;
