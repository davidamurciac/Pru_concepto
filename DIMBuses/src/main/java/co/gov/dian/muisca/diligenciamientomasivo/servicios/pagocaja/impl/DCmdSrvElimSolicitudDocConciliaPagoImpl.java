...
import co.gov.dian.muisca.diligenciamientomasivo.servicios.pagocaja.DCmdSrvElimSolicitudDocConciliaPago;
 ...
 * </pre>
 */
public class DCmdSrvElimSolicitudDocConciliaPagoImpl extends DCmdSrvElimSolicitudDocConciliaPago {
   ...
   * consulta de SolicitudDocConciliaPago o si el objeto no existe
   */
  protected void ejecutarComando() throws DExcepcion {
    ...
    try {
      ...
      // Eliminar
      dao.inicializarEliminar(pkSolicitudDocConciliaPago);
      admin.eliminar(dao);
    }
    finally {
      admin.cerrarSesion();
