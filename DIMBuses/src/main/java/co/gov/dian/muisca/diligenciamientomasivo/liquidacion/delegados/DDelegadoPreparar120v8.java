 ...
 * @version 1.0
 */
public class DDelegadoPreparar120v8 extends DDelegadoPreparar {
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Parámetros para la Liquidación del Formulario 120 versión 8");
        metaLiquidacion.setIdPersonaRut(idPersonaRut);
        metaLiquidacion.setIdFormatoDocIn(120);
        metaLiquidacion.setVersionFtoDocIn(8);
