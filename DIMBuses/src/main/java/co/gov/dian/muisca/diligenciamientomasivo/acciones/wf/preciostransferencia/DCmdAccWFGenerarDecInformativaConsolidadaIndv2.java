...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv2 extends DComandoWF {

    /*Atributos*/
    protected static Logger logger = Logger.getLogger(
            DCmdAccWFGenerarDecInformativaConsolidadaIndv2.class);
    ...
    public DCmdAccWFGenerarDecInformativaConsolidadaIndv2() {
    }
    ...
    protected void asignarWF(IDComando comando) {
        if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidadaIndv2){
            DCmdAccWFGenerarDecInformativaConsolidadaIndv2 copia = (DCmdAccWFGenerarDecInformativaConsolidadaIndv2)comando;
    ...
    public Object clonar() {
        return new DCmdAccWFGenerarDecInformativaConsolidadaIndv2();
    }
    ...
    public String getDescripcion() {
        return "Comando WF que genera una declaraci�n 120 Version 2";
    }
