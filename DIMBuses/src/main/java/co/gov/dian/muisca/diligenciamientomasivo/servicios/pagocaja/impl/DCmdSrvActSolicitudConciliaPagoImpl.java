...
import co.gov.dian.muisca.diligenciamientomasivo.servicios.pagocaja.DCmdSrvActSolicitudConciliaPago;
 ...
 * </pre>
 */
public class DCmdSrvActSolicitudConciliaPagoImpl extends DCmdSrvActSolicitudConciliaPago {
   ...
   * actualizaci� de SolicitudConciliaPago
   */
  protected void ejecutarComando() throws DExcepcion {
    ...
    try {
      ...
      // Actualizar
      dao.inicializarActualizar(toSolicitudConciliaPago);
      admin.guardar(dao);
    }
    finally {
      admin.cerrarSesion();
