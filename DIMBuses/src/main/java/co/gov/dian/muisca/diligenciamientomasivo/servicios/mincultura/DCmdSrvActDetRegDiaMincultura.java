 ...
 * <p>Descripcion: Comando de servicio utilizado para actualizar un objeto DetRegDiaMincultura.</p>
 ...
 * </pre>
 */
public class DCmdSrvActDetRegDiaMincultura extends DComandoServicioInterno {
	private static final long serialVersionUID = -408310601L; 
	 ...
	 * la actualización de DetRegDiaMincultura
	 */
	...
	public Object clonar() {
		return new DCmdSrvActDetRegDiaMincultura();
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdSrvActDetRegDiaMincultura) {
			DCmdSrvActDetRegDiaMincultura copia = (DCmdSrvActDetRegDiaMincultura) comando;
