 ...
 *
 * $Header: DCmdAccMigTareasDoc130v8Impl.java, 9, 2/3/09 8:54:50 PM COT, ARMANDO PEREA MORA$
 */
...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.migracion.DCmdAccMigTareasDoc130v9;
 ...
 * y Tareas de documentos 130 version 9</p>
 ...
 *       ZULUAGA MOLINA Se cambia el llamado a la acción que crea el
...
public class DCmdAccMigTareasDoc130v9Impl extends DCmdAccMigTareasDoc130v9 {
  ...
  private static final int IDE_FORMATO_SOLICITUD = 10006;
	...
	private void definirIdentificadores(int formato, int versionFormato) throws DExcepcion {
		...
		if (ideFlujo == null) {
			throw new DExcepcion("No se encontr� una configuraci�n valida para el formato y version dados", "La configuraci�n de carga masiva  del formato: " + formato + " versi�n: " + versionFormato
   ...
   * Constructor
   */
  public DCmdAccMigTareasDoc130v9Impl() {
  }
  ...
  /**
   * Obtiene la informaci�n de un 130 Presentado como solicitud exogena
   *
   * @param ideDocumento Long
   * @param numRepeticion Integer
   * @return Collection
  ...
  private DIdentificadorDoc obtenerIdentificadorDocCarga(Long
    ...
    if (numeroDocumento == null) {
      throw new DExcepcion("El n�mero de documento es nulo",
        ...
        "El n�mero de documento es nulo");
    }
  ...
  private void crearExpedienteCargaMasiva(DSolicitudIngresoTO solicitud) throws
    ...
    if (idenDocCargaMasiva == null) {
      throw new DExcepcion("Error", "No fue posible hallar el " +
        "Identificador de Documento del Documento n�mero" +
        solicitud.getSolicitudPK().getIdeSolicitud());
    }
  ...
  private DHelperExpedienteGeneracion130v9 getManejadorExpedientes() {
    if (manejadorExpedientes == null) {
      manejadorExpedientes =
        new DHelperExpedienteGeneracion130v9(this);
    }
  ...
  protected void ejecutarComando() {
    ...
    /*
      ...
      */
     /**@todo REVISAR LAS CUESTIONES DE TX CUANDO FALLA ALGO EN LA EJECUCI�N DE UN COMANDO DE WF*/
     /*                try {
      ...
      */
     /**
      * Consulta los par�metros de entrada y salida de la actividad y
      * los asigna al comando de WF.
      *
      * @throws DExcepcion Si ocurre alg�n error al consultar los
      * par�metros
      */
     /*        public Collection consultarParametrosWF(IDContextoWF contextoWF) throws DExcepcion
             {
                 // Cargar los par�metros de la actividad
