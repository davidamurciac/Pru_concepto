 ...
 * <p>Descripcion: Comando de acci�n utilizado para crear un objeto SolicitudConciliaPago.</p>
 ...
 * </pre>
 */
public class DCmdAccCrearSolicitudConciliaPago extends DComandoAccion {
  ...
  public Object clonar() {
    return new DCmdAccCrearSolicitudConciliaPago();
  }
  ...
  public void asignar(IDComando comando) {
    if (comando instanceof DCmdAccCrearSolicitudConciliaPago) {
      DCmdAccCrearSolicitudConciliaPago copia = (DCmdAccCrearSolicitudConciliaPago) comando;
