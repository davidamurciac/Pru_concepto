 ...
 *
 * $Header: DCmdAccProcesarMigTareasDocs130v7Impl.java, 4, 1/31/08 3:14:53 PM COT, ARMANDO PEREA MORA$
 */
...
public class DCmdAccProcesarMigTareasDocs130v7Impl extends
  DCmdAccProcesarMigTareasDocs130v7 {
  private static final Logger logger = Logger.getLogger(
    DCmdAccProcesarMigTareasDocs130v7Impl.class);

  public DCmdAccProcesarMigTareasDocs130v7Impl() {
  }
  ...
  private void procesarDocumento(Long ideDocumento,
    ...
    try {
      ...
      DCmdAccMigTareasDoc130v7 cmdAccMig = (DCmdAccMigTareasDoc130v7)
        getAccionOtroContexto(
        "diligenciamientomasivo.migracion.DCmdAccMigTareasDoc130v7", true);
