 ...
 * @version 1.0
 */
public class DDelegadoPreparar120v3 extends DDelegadoPreparar {
    ...
    public IDDocumento cargarLiquidacion() throws DExcepcion {
        ...
        metaLiquidacion.setDescripcion("Par�metros para la Liquidaci�n del Formulario 120 versi�n 3");
        metaLiquidacion.setIdPersonaRut(idPersonaRut);
        metaLiquidacion.setIdFormatoDocIn(120);
        metaLiquidacion.setVersionFtoDocIn(3);
