...
public class DCmdAccWFGenerarDecInformativaConsolidadaIndv9 extends DComandoWF {

    /*Atributos*/
    protected static Logger logger = Logger.getLogger(
            DCmdAccWFGenerarDecInformativaConsolidadaIndv9.class);
    ...
    public DCmdAccWFGenerarDecInformativaConsolidadaIndv9() {
    }
    ...
    protected void asignarWF(IDComando comando) {
        if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidadaIndv9){
            DCmdAccWFGenerarDecInformativaConsolidadaIndv9 copia = (DCmdAccWFGenerarDecInformativaConsolidadaIndv9)comando;
    ...
    public Object clonar() {
        return new DCmdAccWFGenerarDecInformativaConsolidadaIndv9();
    }
    ...
    public String getDescripcion() {
        return "Comando WF que genera una declaraci�n 120 Version 9";
    }
