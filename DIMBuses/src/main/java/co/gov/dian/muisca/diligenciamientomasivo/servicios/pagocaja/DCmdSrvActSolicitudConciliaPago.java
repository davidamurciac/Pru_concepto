 ...
 * <p>Descripcion: Comando de servicio utilizado para actualizar un objeto SolicitudConciliaPago.</p>
 ...
 * </pre>
 */
public class DCmdSrvActSolicitudConciliaPago extends DComandoServicioNegocio {
  ...
  /**
   * Inicializa la actualizaci� de SolicitudConciliaPago.
   ...
   * la actualizaci�n de SolicitudConciliaPago
   */
  ...
  public Object clonar() {
    return new DCmdSrvActSolicitudConciliaPago();
  }
  ...
  public String getDescripcion() {
    return "Permite actualizar un objeto SolicitudConciliaPago";
  }
  ...
  public void asignar(IDComando comando) {
    if (comando instanceof DCmdSrvActSolicitudConciliaPago) {
      DCmdSrvActSolicitudConciliaPago copia = (DCmdSrvActSolicitudConciliaPago) comando;
