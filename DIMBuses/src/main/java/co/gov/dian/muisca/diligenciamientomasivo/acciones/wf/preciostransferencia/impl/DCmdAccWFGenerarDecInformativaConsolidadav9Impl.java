...
import co.gov.dian.muisca.diligenciamientomasivo.acciones.wf.preciostransferencia.DCmdAccWFGenerarDecInformativaConsolidadav9;
...
import co.gov.dian.muisca.diligenciamientomasivo.general.preciostransferencia.DHelperExpedienteGeneracion130v9;
 ...
 * @version 1.0
 */
public class DCmdAccWFGenerarDecInformativaConsolidadav9Impl extends
  DCmdAccWFGenerarDecInformativaConsolidadav9 {

  private static final Logger logger = Logger.getLogger(
        DCmdAccWFGenerarDecInformativaConsolidadav9Impl.class);
...
//Casillas del 120 para matriz
  ...
  private static final int VERSION_FORMATO = 9;
  ...
  //Helpers
  DHelperExpedienteGeneracion130v9 manejadorExpedientes = null;

  public DCmdAccWFGenerarDecInformativaConsolidadav9Impl() {
  }
  ...
  private DHelperExpedienteGeneracion130v9 getManejadorExpedientes() {
  ...
  protected void ejecutarComandoSinTransaccion() {
    logger.info("Inicio WF Decl. Inf. Precios de Transferencia Consolidada v9");
  ...
  private Long notificarResponsable(DSolicitudIngresoTO miSolicitud,
      ...
      if (procesarValido) {
          ...
          urlTarea = "/WebDiligenciamientomasivo/DefPreciosTransConsolidadav9.faces";
      }
