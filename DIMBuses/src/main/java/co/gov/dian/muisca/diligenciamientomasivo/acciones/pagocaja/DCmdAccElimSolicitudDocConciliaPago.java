 ...
 * <p>Descripcion: Comando de acci� utilizado para eliminar un objeto SolicitudDocConciliaPago.</p>
 ...
 * </pre>
 */
public class DCmdAccElimSolicitudDocConciliaPago extends DComandoAccion {
  /** Llave primaria de SolicitudDocConciliaPago */
  protected DSolicitudDocConciliaPagoPKTO pkSolicitudDocConciliaPago;

  /**
   * Inicializa la eliminaci� de SolicitudDocConciliaPago.
  ...
  public Object clonar() {
    return new DCmdAccElimSolicitudDocConciliaPago();
  }
  ...
  public void asignar(IDComando comando) {
    if (comando instanceof DCmdAccElimSolicitudDocConciliaPago) {
      DCmdAccElimSolicitudDocConciliaPago copia = (DCmdAccElimSolicitudDocConciliaPago) comando;
