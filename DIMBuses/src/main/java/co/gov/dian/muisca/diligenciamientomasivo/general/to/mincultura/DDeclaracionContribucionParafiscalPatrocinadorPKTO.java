 ...
 * <p>Descripcion: Objeto de transporte para la PK de DeclaracionContribucionParafiscalPatrocinador.</p>
 ...
 * </pre>
 */
public class DDeclaracionContribucionParafiscalPatrocinadorPKTO implements IDTO {

	private static final long serialVersionUID = 1159474681L; 
  ...
  // Campos de la PK
	...
	/**
	 * Construye un nuevo DDeclaracionContribucionParafiscalPatrocinadorPKTO por defecto.
	 */
	public DDeclaracionContribucionParafiscalPatrocinadorPKTO() { }

	/**
	 * Construye un nuevo DDeclaracionContribucionParafiscalPatrocinadorPKTO con los elementos de la llave primaria.
	 ...
	 */
	public DDeclaracionContribucionParafiscalPatrocinadorPKTO(java.lang.Long ideDocumentoContParaf, java.lang.Integer numRepeticionDocContParf, java.lang.Integer ideOcurrencia, java.lang.Integer ideItem) {
	...
	public boolean equals(Object objeto) {
		...
		if (!(objeto instanceof DDeclaracionContribucionParafiscalPatrocinadorPKTO)) {
			return false;
		}
		DDeclaracionContribucionParafiscalPatrocinadorPKTO otro = (DDeclaracionContribucionParafiscalPatrocinadorPKTO) objeto;
