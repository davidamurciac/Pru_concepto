 ...
 * <p>Descripcion: Comando de acción utilizado para actualizar un objeto DeclaracionContribucionParafiscal.</p>
 ...
 * </pre>
 */
public class DCmdAccActDeclaracionContribucionParafiscal extends DComandoAccion {
	private static final long serialVersionUID = -1471310397L; 
	...
	public Object clonar() {
		return new DCmdAccActDeclaracionContribucionParafiscal();
	}
	...
	public String getDescripcion() {
		return "Permite actualizar un objeto DeclaracionContribucionParafiscal";
	}
	...
	public void asignar(IDComando comando) {
		if (comando instanceof DCmdAccActDeclaracionContribucionParafiscal) {
			DCmdAccActDeclaracionContribucionParafiscal copia = (DCmdAccActDeclaracionContribucionParafiscal) comando;
