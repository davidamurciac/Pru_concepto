...
/**
 * <p>Title: DCmdAccWFGenerarDecInformativaConsolidadav1</p>
 ...
 * @version 1.0
 */
public class DCmdAccWFGenerarDecInformativaConsolidadav1 extends DComandoWF {

    /*Atributos*/
    protected static Logger logger = Logger.getLogger(
            DCmdAccWFGenerarDecInformativaConsolidadav1.class);
    ...
    public DCmdAccWFGenerarDecInformativaConsolidadav1() {
    }
    ...
    protected void asignarWF(IDComando comando) {
        if(comando instanceof DCmdAccWFGenerarDecInformativaConsolidadav1){
            DCmdAccWFGenerarDecInformativaConsolidadav1 copia = (DCmdAccWFGenerarDecInformativaConsolidadav1)comando;
    ...
    public Object clonar() {
        return new DCmdAccWFGenerarDecInformativaConsolidadav1();
    }
